...
const User = require('../../core/authentication/usersModel');
const { signupSchema, signinSchema } = require('../../shared/utilities/validators/authValidators');
const { doHash, doHashValidation } = require('../../shared/utilities/hashing');
